...
const articleEl = document.getElementById('blog-post') as HTMLElement;
const titleEl = document.getElementById('blog-post-title') as HTMLElement;
const dateEl = document.getElementById('blog-post-date') as HTMLElement;
const contentEl = document.getElementById('blog-post-content') as HTMLElement;
const pageTitleEl = document.getElementById('page-title') as HTMLTitleElement;
